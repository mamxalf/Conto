...
class RoutersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @router.save
        format.html { redirect_to router_url(@router), notice: 'Router was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @router.update(router_params)
        format.html { redirect_to router_url(@router), notice: 'Router was successfully updated.' }
